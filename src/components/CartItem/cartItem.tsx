...
import {useCartContext} from "../../context/contextShop";

const CartItem = ({id, img, title, price, quantity}: items) => {
    ...
    return (
        <div className="d-flex justify-content-between align-items-center mt-3">
            <div className="d-block d-sm-flex align-items-center text-center text-sm-end">
                <img src={img} width="120" className="ms-3 rounded mx-3" alt="Pizza" />
